                ...
                <div class="register-bottom-grid">
                    <div style="display: block" id="apply_for">
                        ...
                        <div class="input">
                            ...
                            <input type="text" id="username" style="width: 300px;float: left;margin-left: 23px"><br>
                        </div>
                        <div class="input">
                            <span>Secret question (密保问题选项 ：) <label style="color: red"> *用于重置密码</label></span>
                            <div>
                                <span style="float: left;margin-top: 5px">密保问题：</span>
                                <select style="width:500px;height: 30px;float: left">
                                    <option></option>
                                    <option></option>
                                    <option></option>
                                </select>
                    ...
                    <div id="security_settings" style="display: none">
                        ...
                        <div class="input">
                            <span>Password (密码 ：) <label style="color: red"> *用来验证登陆</label></span>
                        ...
                        <div id="Payment_codepswd" style="display: none">
                            <div class="input">
                                <span> payment code (支付密码 ：) <label style="color: red;"> *用来购买支付验证</label></span>
                        ...
                        <div class="register-but">
                            <input type="button" id="butto" value="确认提交">
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
